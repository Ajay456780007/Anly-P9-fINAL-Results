# 1. PROJECT TITLE
    Design and developement of a LLM enabled explainable CNN based encoder decoder and decoder model for Fruit disease classification and Pesticides Suggestion
...
# 4. HOW TO RUN
    ...
    [Execution time expected: “Full analysis +Plots” — 10 hr]
    [Execution time expected: “Plots from pre evaluated data” – 30 sec]

# 5. IMPORTANT PYTHON FILE AND DESCRIPTION:
    1: preprocessing function  - bilateral filter and median filter  inside thE Read_data file indide the Sub_Functions folder
    2: Feature Extraction - inside the feature extraction folder 
    3: Analysis  - inside the Sub_Functions folder Anlysis.py file


# 6. Download Dataset using this link 
    Dataset 1 : ("https://www.kaggle.com/datasets/warcoder/mangofruitdds")
    Dataset 2 : ("https://data.mendeley.com/datasets/yvcwypp8rz/1") 
